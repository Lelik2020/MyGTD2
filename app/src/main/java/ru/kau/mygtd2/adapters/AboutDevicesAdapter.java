...
public class AboutDevicesAdapter extends RecyclerView.Adapter<AboutDevicesAdapter.ViewHolder>{

    Context c;
    List<Device> lstDevices;


    private ClickListener clicklistener; // = (ClickListener) ((MainActivity) c).getSupportFragmentManager().findFragmentById(R.id.frame_container);

    public AboutDevicesAdapter(Context c, List<Device> lstDevices){
        this.c = c;
    ...
    */
    ...
    @NonNull
    @Override
    public AboutDevicesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        clicklistener = (ClickListener) ((MainActivity) c).getSupportFragmentManager().findFragmentById(R.id.frame_container);
        ...
        return new AboutDevicesAdapter.ViewHolder(v);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull AboutDevicesAdapter.ViewHolder viewHolder, int i) {
        viewHolder.title.setText(lstDevices.get(i).getTitle());
    ...
    public void setAllUnvisible(@NonNull AboutDevicesAdapter.ViewHolder viewHolder){
