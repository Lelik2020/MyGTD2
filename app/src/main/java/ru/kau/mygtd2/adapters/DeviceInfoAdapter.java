...
public class DeviceInfoAdapter extends RecyclerView.Adapter<DeviceInfoAdapter.ViewHolder>{
    ...
    Context c;
    List<DeviceInfo> lstDeviceInfo;


    private ClickListener clicklistener = null;

    public DeviceInfoAdapter(Context c, List<DeviceInfo> lstDeviceInfo){
        this.c = c;
    ...
    */
    ...
    @NonNull
    @Override
    public DeviceInfoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View v= LayoutInflater.from(c).inflate(R.layout.deviceinfo_cardview,viewGroup,false);
        ...
        return new DeviceInfoAdapter.ViewHolder(v);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull DeviceInfoAdapter.ViewHolder viewHolder, int i) {
        viewHolder.title.setText(lstDeviceInfo.get(i).getKey() + " " + lstDeviceInfo.get(i).getValue());
    ...
    public void setAllUnvisible(@NonNull DeviceInfoAdapter.ViewHolder viewHolder){
