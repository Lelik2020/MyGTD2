...
import ru.kau.mygtd2.ui.FastScroller;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holderAll, final int position) {
        ...
        if (holderAll instanceof StarsTitleViewHolder) {
            ...
            if (holder.clearAllFolders != null) {
                TxtUtils.underlineTextView(holder.clearAllFolders).setOnClickListener(new View.OnClickListener() {
            ...
            if (holder.clearAllBooks != null) {
                TxtUtils.underlineTextView(holder.clearAllBooks).setOnClickListener(new View.OnClickListener() {
            ...
            if (holder.onGridList != null) {
                ...
                holder.onGridList.setOnClickListener(new View.OnClickListener() {
        ...
        if (holderAll instanceof FileMetaViewHolder) {
            ...
            holder.starredName.setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(final View v) {
                    MyPopupMenu menu = new MyPopupMenu(v.getContext(), v);

                    menu.getMenu().add(STARRED).setIcon(R.drawable.star_1).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                    ...
                    menu.getMenu().add(nameName).setIcon(R.drawable.glyphicons_160_playlist).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            aHolder.parent.setOnClickListener(new View.OnClickListener() {
    ...
    private FileMeta bindFileMetaView(final FileMetaViewHolder holder, final int position) {
        ...
        if (holder.series != null && onSeriesClickListener != null) {
            ...
            if (TxtUtils.isNotEmpty(sequence)) {
                ...
                holder.series.setOnClickListener(new View.OnClickListener() {
        ...
        /*if (onStarClickListener != null) {
            ...
            holder.star.setOnLongClickListener(new View.OnLongClickListener() {
        ...
        if (holder.signIcon != null) {
            holder.signIcon.setOnClickListener(new View.OnClickListener() {
