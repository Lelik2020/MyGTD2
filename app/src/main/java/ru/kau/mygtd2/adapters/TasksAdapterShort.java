...
public class TasksAdapterShort extends RecyclerView.Adapter<TasksAdapterShort.ViewHolder>{
    ...
    public TasksAdapterShort(Context c, List<Task> lstTask) {
        this.c = c;
    ...
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull TasksAdapterShort.ViewHolder viewHolder, int i) {
    ...
    private Task bindTaskView(final TasksAdapterShort.ViewHolder holder, final int position) {
