    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        switch (i){
            ...
            case 3:
                ...
                count = MyApplication.getDatabase().taskDao().getCountAllTasksOfHotToday(Utils.getEndOfDay(currDate).getTime(), Utils.dateToString(DEFAULT_DATEFORMAT_WITHMINUTES, Utils.getEndOfDay(new Date())), lstStatus, lstHIPRIORITY);
            ...
            case 4:
                ...
                count = MyApplication.getDatabase().taskDao().getCountOutstandingFavourite(Utils.getStartOfDay(ss currDate).getTime(), lstStatus, lstALLPRIORITY, lstALLPROJECTSID);
