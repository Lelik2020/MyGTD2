...
public class BackupsAdapter extends RecyclerView.Adapter<BackupsAdapter.ViewHolder>{
    ...
    public BackupsAdapter(Context c, List<Category> lstCategories){
        this.c = c;
    ...
    */
    ...
    @NonNull
    @Override
    public BackupsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View v= LayoutInflater.from(c).inflate(R.layout.backup_cardview,viewGroup,false);

        //GradientDrawable drawable = new GradientDrawable();
        //drawable.setStroke(2, R.color.black);
    ...
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull BackupsAdapter.ViewHolder viewHolder, int i) {
        viewHolder.title.setText(lstCategories.get(i).getTitle());
        Log.e(lstCategories.get(i).getTitle(), lstCategories.get(i).getTitle());
    ...
    public void setAllUnvisible(@NonNull MainAdapter.ViewHolder viewHolder){
