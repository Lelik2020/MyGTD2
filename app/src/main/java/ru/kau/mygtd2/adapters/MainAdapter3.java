...
public class MainAdapter3 extends RecyclerView.Adapter<MainAdapter3.ViewHolder>{
    ...
    public MainAdapter3(Context c, List<Category> lstCategories){
        this.c = c;
    ...
    */
    ...
    @NonNull
    @Override
    public MainAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new MainAdapter3.ViewHolder(v);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull MainAdapter3.ViewHolder viewHolder, int i) {
            ...
            main.setOnClickListener(new View.OnClickListener(){
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if(clicklistener !=null){
                                                clicklistener.itemClicked(v,getAdapterPosition(), 3);
                                            }
                                        }
                                    }
            );
    ...
    public void setAllUnvisible(@NonNull MainAdapter3.ViewHolder viewHolder){
