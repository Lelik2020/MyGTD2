package ru.kau.mygtd2.utils.google;
...
import ru.kau.mygtd2.services.GTDService;
...
//            }
    ...
    public static void runSyncService(Activity a, boolean force) {
        ...
        try {
            if (AppSP.get().isEnableSync && !GTDService.isRunning) {
...
//                }
                ...
                if (account != null) {
                    ...
                    GTDService.startForeground(a, GTDService.ACTION_RUN_SYNCRONICATION);
                }
            }
        } catch (Exception e) {
            LOG.e(e);
