package ru.kau.mygtd2.utils.common.bitmaps;
...
import ru.kau.mygtd2.enums.PagePaint;
...
public class Bitmaps {
    ...
    public boolean reuse(final String nodeId, final BitmapRef orig, final Rect bitmapBounds, final boolean invert) {
        ...
        try {
            final Bitmap origBitmap = orig.getBitmap();
            final Bitmap.Config cfg = useDefaultBitmapType ? DEF_BITMAP_TYPE : origBitmap.getConfig();
            if (cfg != this.config) {
                return false;
            }
