package ru.kau.mygtd2.utils.info.view;
...
import ru.kau.mygtd2.utils.info.widget.DraggbleTouchListener;
...
public abstract class DragingPopup {
    ...
    public DragingPopup show(String tag, boolean always, boolean update) {
        ...
        if (titleAction != null) {
            ...
            popupView.findViewById(R.id.onTitleAction).setOnClickListener(new View.OnClickListener() {
        ...
        if (titlePopupMenu == null) {
            ...
            onIconAction.setOnClickListener(new View.OnClickListener() {
        ...
        topHeaderLayout.setOnTouchListener(new View.OnTouchListener() {
