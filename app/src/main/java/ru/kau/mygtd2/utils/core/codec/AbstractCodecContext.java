...
import ru.kau.mygtd2.exceptions.codec.MuPdfPasswordException;
import ru.kau.mygtd2.exceptions.codec.MuPdfPasswordRequiredException;
...
public abstract class AbstractCodecContext implements CodecContext {
    ...
    public CodecDocument openDocument(String fileNameOriginal, String password) {
        ...
        try {
            String fileName = CacheZipUtils.extracIfNeed(fileNameOriginal, CacheZipUtils.CacheDir.ZipApp).unZipPath;
