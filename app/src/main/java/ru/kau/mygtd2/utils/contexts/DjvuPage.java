...
import ru.kau.mygtd2.settings.CoreSettings;
...
import ru.kau.mygtd2.utils.core.codec.AbstractCodecPage;
import ru.kau.mygtd2.utils.core.codec.Annotation;
import ru.kau.mygtd2.utils.core.codec.PageLink;
import ru.kau.mygtd2.utils.core.codec.PageTextBox;
...
public class DjvuPage extends AbstractCodecPage {
    ...
    DjvuPage(final long contextHandle, final long docHandle, final long pageHandle, final int pageNo, String filename) {
        ...
        sp = MyGTDApp.context.getSharedPreferences("djvu", Context.MODE_PRIVATE);
