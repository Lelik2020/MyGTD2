package ru.kau.mygtd2.services;
...
import ru.kau.mygtd2.utils.msg.MessageSync;
import ru.kau.mygtd2.utils.msg.MessageSyncFinish;
import ru.kau.mygtd2.utils.msg.UpdateAllFragments;

public class GTDService extends IntentService {
    ...
    public static void startForeground(Activity a, String action) {
        final Intent intent = new Intent(a, GTDService.class).setAction(action);
...
//        }
    ...
    public void startMyForeground() {
        if (!isStartForeground) {
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
                Notification notification = new NotificationCompat.Builder(this, MyNotification.DEFAULT) //
                ...
                startForeground(MyNotification.NOT_ID_2, notification);
            }
    ...
    private void sendProggressMessage() {
        ...
        Intent itent = new Intent(INTENT_NAME).putExtra(Intent.EXTRA_TEXT, RESULT_SEARCH_COUNT).putExtra(Intent.EXTRA_INDEX, 100);
