...
public class SlidingTabStrip extends LinearLayout {
    ...
    private static final int DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 20;
    private static final int SELECTED_INDICATOR_THICKNESS_DIPS = 3;
    private static final int DEFAULT_SELECTED_INDICATOR_COLOR = Color.TRANSPARENT;// Color.parseColor("#f04646");
    // private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFFFFFFFF;

    private static final int DEFAULT_DIVIDER_THICKNESS_DIPS = 1;
    private static final int DEFAULT_DIVIDER_COLOR_ALPHA = 26;
