...
public class MyPopupMenu {
    ...
    public void show(int pos, boolean isLong) {
        ...
        if (AppState.get().isEnableAccessibility) {
            getMenu(0).add(R.string.close).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                @Override
        ...
        BaseItemLayoutAdapter<Menu> a = new BaseItemLayoutAdapter<Menu>(c, R.layout.item_dict_line, list) {
            ...
            public void populateView(View layout, int position, final Menu item) {
                ...
                if (item.iconRes != 0) {
                    ...
                    if (item.iconRes == R.mipmap.app_icon11 || Boolean.TRUE.equals(item.active)) {
        ...
        if (anchor != null) {
            ...
            p1.setModal(true);
            p1.setOnDismissListener(new PopupWindow.OnDismissListener() {
    ...
    public class Menu {
        ...
        public Menu setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onclick) {
            this.click = onclick;
            return this;
        }

        public Menu setOnMenuItemLongClickListener(MenuItem.OnMenuItemClickListener onLongClick) {
